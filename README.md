...
- ### CelebA Datasets
    ...
    - CelebA-HQ-img2.zip<br>(contains the <b>celebaHQ</b> dataset images from 0.jpg to 14999.jpg)
    - CelebAMask-HQ-mask-anno.zip<br>this file contains <b>the masks for CelebA-HQ dataset</b> from the <b>CelebAMask-HQ</b> (same as above)<br>the folder contains:
